...
// @description:ar    إضافة ChatGPT للمحادثة السلسة. مفتوحة المصدر ومجانية. ليس فقط لحل جميع الأخطاء وتجنب إعادة التحميل، بل لديها أيضًا العديد من الميزات المتقدمة مثل البقاء نشطًا، إلغاء التدقيق، استنساخ المحادثة، تنقية الصفحة الرئيسية، عرض الشاشة الكبيرة وعرض الشاشة الكاملة وغيرها الكثير. دع تجربة AI لدينا تكون سلسة وناعمة وفعالة وبسيطة للغاية.
// @description:bg    ChatGPT плъгин за безпроблемно чатиране. Отворен код и безплатен. Не само решава всички грешки и презареждания, но има и множество напреднали функции като поддръжка на активност, отмяна на одита, клониране на разговор, почистване на началната страница, показване на голям екран, показване на цял екран и други. Нека нашият AI опит бъде изключително безпроблемен, гладък, ефективен и прост.
// @description:cs    ChatGPT plugin pro bezproblémové chatování. Open source a zdarma. Nejenže řeší všechny chyby bez nutnosti obnovování stránky, ale nabízí také řadu pokročilých funkcí, jako je udržování aktivity, zrušení auditu, klonování rozhovoru, čištění domovské stránky, zobrazení na velké obrazovce, zobrazení na celou obrazovku a další. Dejte našemu AI zážitku neuvěřitelnou plynulost, hladkost, efektivitu a jednoduchost.
// @description:da    ChatGPT-plugin til problemfri chat. Åben kildekode og gratis. Ikke kun løser det alle fejl og undgår genindlæsning, men det har også mange avancerede funktioner som at holde sig aktiv, annullere revision, klone samtale, rense startside, vise stor skærm, vise fuld skærm og meget mere. Lad vores AI-oplevelse være utrolig problemfri, glat, effektiv og enkel.
// @description:de    ChatGPT-Plugin für nahtloses Chatten. Open Source und kostenlos. Es löst nicht nur alle Fehler und vermeidet das Neuladen, sondern bietet auch viele fortschrittliche Funktionen wie aktives Bleiben, Auditaufhebung, Konversation klonen, Startseite bereinigen, Vollbildanzeige, Großbildanzeige und vieles mehr. Lassen Sie unsere KI-Erfahrung extrem nahtlos, geschmeidig, effizient und einfach sein.
// @description:el    Πρόσθετο ChatGPT για άψογη συνομιλία. Ανοιχτός κώδικας και δωρεάν. Δεν απλώς επιλύει όλα τα σφάλματα και αποφεύγει την ανανέωση, αλλά έχει επίσης πολλές προηγμένες λειτουργίες, όπως παραμονή ενεργής, ακύρωση ελέγχου, κλωνοποίηση συνομιλίας, καθαρισμός αρχικής σελίδας, προβολή μεγάλης οθόνης, προβολή πλήρους οθόνης και πολλά άλλα. Ας κάνουμε την εμπειρία της τεχνητής νοημοσύνης μας απίστευτα άνετη, λεία, αποτελεσματική και απλή.
// @description:en    ChatGPT plugin for seamless chatting. Open source and free. It not only solves all errors and avoids refreshing, but also has multiple advanced features such as staying active, disabling audits, cloning conversations, cleaning the homepage, displaying large screens, displaying full screens, and many more. Let's make our AI experience incredibly smooth, silky, efficient, and concise.
// @description:eo    Kromprogramo ChatGPT por senzorga babilado. Malferma fonto kodo kaj senpaga. Ĝi ne nur solvas ĉiujn erarojn kaj evitas refreŝigon, sed havas ankaŭ plurajn spertajn funkciojn, kiel ekzemple restado aktiva, malkancelado de revizoj, klonado de interparoloj, purigado de hejmpaĝo, montrado de grandaj ekranoj, montrado de plenekranaj bildoj, kaj multe pli. Faru nian KI-peron nekredeble senzorgan, glatan, efikan, kaj simplan.
// @description:es    Plugin de ChatGPT para conversaciones sin problemas. Código abierto y gratuito. No solo resuelve todos los errores y evita la actualización, sino que también tiene múltiples funciones avanzadas como mantenerse activo, desactivar auditorías, clonar conversaciones, limpiar la página de inicio, mostrar pantallas grandes, mostrar pantalla completa y muchas más. Hagamos que nuestra experiencia de IA sea increíblemente fluida, suave, eficiente y concisa.
// @description:fi    ChatGPT-liitännäinen saumattomaan keskusteluun. Avoin lähdekoodi ja ilmainen. Se ei ainoastaan ratkaise kaikkia virheitä eikä vaadi sivun päivittämistä, vaan siinä on myös useita edistyneitä toimintoja, kuten aktiivisena pysyminen, tarkistuksen perumisen, keskustelun kloonaamisen, etusivun puhdistamisen, suuren näytön näyttämisen, kokoruudun näyttämisen ja paljon muuta. Tehdään tekoälykokemuksestamme uskomattoman saumaton, pehmeä, tehokas ja ytimekäs.
// @description:fr    Plugin ChatGPT pour une conversation fluide. Open source et gratuit. Il résout non seulement toutes les erreurs et évite le rafraîchissement, mais propose également plusieurs fonctionnalités avancées telles que le maintien de l'activité, la désactivation des audits, la duplication de la conversation, le nettoyage de la page d'accueil, l'affichage en grand écran, l'affichage en plein écran, et bien plus encore. Rendons notre expérience IA incroyablement fluide, soyeuse, efficace et concise.
// @description:fr-CA Plugin ChatGPT pour des conversations sans faille. Code source ouvert et gratuit. Non seulement il résout toutes les erreurs et évite de rafraîchir, mais il offre également de nombreuses fonctionnalités avancées telles que la conservation de l'activité, l'annulation de l'audit, le clonage des conversations, le nettoyage de la page d'accueil, l'affichage en grand écran, l'affichage en plein écran, et bien plus encore. Rendons notre expérience d'IA incroyablement fluide, soyeuse, efficace et concise.
// @description:he    תוסף ChatGPT לשיחה חלקה. קוד פתוח וחינמי. התוסף לא רק פותר את כל השגיאות וממנע רענון, אלא גם כולל מספר תכונות מתקדמות כגון שמירה פעילה, ביטול סקירה, שכפול שיחה, ניקוי דף הבית, הצגת מסכים גדולים, הצגת מסך מלא ועוד. בואו נפתיע את חוויית הלמידה שלנו ביכולת חלקה, חלקה, יעילה וקצרה.
// @description:hu    ChatGPT bővítmény zökkenőmentes csevegéshez. Nyílt forráskódú és ingyenes. Nemcsak megold minden hibát és elkerüli az újratöltést, hanem számos haladó funkciót is tartalmaz, mint például az aktív maradás, az auditálás kikapcsolása, a beszélgetés klónozása, a kezdőlap tisztítása, a nagy képernyő megjelenítése, a teljes képernyő megjelenítése és még sok más. Tegyük rendkívül simává, puhanccá, hatékonnyá és tömörévé az AI élményünket.
// @description:id    Plugin ChatGPT untuk chatting yang mulus. Sumber terbuka dan gratis. Tidak hanya memecahkan semua kesalahan dan menghindari pembaruan, tetapi juga memiliki fitur canggih seperti tetap aktif, mematikan audit, menggandakan percakapan, membersihkan halaman beranda, menampilkan layar besar, menampilkan layar penuh, dan banyak lagi. Mari kita buat pengalaman AI kita menjadi sangat mulus, halus, efisien, dan ringkas.
// @description:it    Plugin ChatGPT per una chat senza soluzione di continuità. Open source e gratuito. Non solo risolve tutti gli errori e evita il ricaricamento, ma ha anche molte funzionalità avanzate come rimanere attivi, disattivare le verifiche, clonare le conversazioni, pulire la homepage, visualizzare grandi schermi, visualizzare lo schermo intero e molto altro. Rendiamo la nostra esperienza di IA incredibilmente fluida, setosa, efficiente e concisa.
// @description:ja    ChatGPTのシームレスなチャット用プラグイン。オープンソースで無料です。すべてのエラーを解決し、更新を回避するだけでなく、アクティブに保つ、監査を無効にする、会話を複製する、ホームページをクリーンアップする、大画面を表示する、フルスクリーン表示するなど、さまざまな高度な機能があります。私たちのAI体験を非常にスムーズでシームレス、効率的で簡潔にしましょう。
// @description:ka    ChatGPT-ის პლაგინი უზრუნველყოფს უბრალო ჩატის პლატფორმას. ღია კოდი და უფასოა. ის არა მარაგია ყველა შეცდომას და ეულიარებას, არამხოლოდ ამას აღიქვამს, არამედ უკვეთარი ამბავით ფუნქციებიც, როგორიცაა აქტიურობის შენება, აუდიტის გაუქმება, კონვერსაციის კლონირება, მთავარი გვერდის დასუფთავება, დიდი ეკრანის ჩვენება, სრული ეკრანის ჩვენება და სხვანაირად. გადავაკეთოთ ჩვენი AI გამოცდილება სასარგებლო, მაჩვენებლიანი, ეფექტური და მოკლე გახსნადი იყოს.
// @description:ko    챗지피티 채팅용 플러그인입니다. 오픈 소스이며 무료입니다. 모든 오류를 해결하고 새로 고침을 피하는 것뿐만 아니라 활성 유지, 감사 비활성화, 대화 복제, 홈페이지 정리, 큰 화면 표시, 전체 화면 표시 등 다양한 고급 기능도 제공합니다. AI 경험을 매우 원활하고 부드럽고 효율적이며 간결하게 만들어 봅시다.
// @description:nb    ChatGPT-plugin for sømløs chatting. Åpen kildekode og gratis. Den løser ikke bare alle feil og unngår oppdatering, men har også flere avanserte funksjoner som å holde seg aktiv, deaktivere revisjoner, klone samtaler, rense hjemmesiden, vise store skjermer, vise fullskjerm og mye mer. La oss gjøre AI-opplevelsen vår utrolig sømløs, silkemyk, effektiv og konsis.
// @description:nl    ChatGPT-plugin voor naadloos chatten. Open source en gratis. Het lost niet alleen alle fouten op en vermijdt verversing, maar heeft ook geavanceerde functies zoals actief blijven, audits annuleren, gesprekken klonen, de startpagina opruimen, grote schermen tonen, volledig scherm tonen en nog veel meer. Laten we onze AI-ervaring ongelooflijk soepel, zijdeachtig, efficiënt en beknopt maken.
// @description:pl    Wtyczka ChatGPT umożliwiająca płynne rozmowy. Open source i darmowa. Nie tylko rozwiązuje wszystkie błędy i unika odświeżania, ale posiada także wiele zaawansowanych funkcji, takich jak utrzymywanie aktywności, anulowanie audytu, klonowanie rozmowy, oczyszczanie strony głównej, wyświetlanie dużych ekranów, wyświetlanie pełnoekranowe i wiele więcej. Uczyńmy nasze doświadczenie z AI niezwykle płynnym, jedwabistym, efektywnym i zwięzłym.
// @description:pt-BR Plugin ChatGPT para conversas perfeitas. Código aberto e gratuito. Ele resolve não apenas todos os erros e evita recarregamentos, mas também possui vários recursos avançados, como manter a atividade, cancelar auditorias, clonar conversas, limpar a página inicial, exibir telas grandes, exibir tela cheia e muito mais. Vamos tornar nossa experiência de IA incrivelmente fluida, suave, eficiente e concisa.
// @description:ro    Pluginul ChatGPT pentru conversații fără probleme. Open source și gratuit. Nu doar rezolvă toate erorile și evită reîmprospătarea, dar oferă și mai multe funcționalități avansate precum menținerea activității, anularea auditului, clonarea conversațiilor, curățarea paginii principale, afișarea pe ecrane mari, afișarea pe tot ecranul și multe altele. Să facem experiența noastră de IA incredibil de fluentă, catifelată, eficientă și concisă.
// @description:ru    Плагин ChatGPT для беспроблемного чата. Открытый и бесплатный. Он не только исправляет все ошибки и избегает обновлений, но также имеет множество продвинутых функций, таких как активное сохранение, отключение аудита, клонирование диалогов, очистка домашней страницы, отображение больших экранов, отображение полного экрана и многое другое. Давайте сделаем наше AI-впечатление невероятно плавным, шелковистым, эффективным и лаконичным.
// @description:sk    ChatGPT plugin pre bezproblémové chatovanie. Open source a zadarmo. Nielenže rieši všetky chyby a vyhýba sa obnoveniu, ale ponúka aj viacero pokročilých funkcií, ako je udržiavanie aktivity, zrušenie audítu, klonovanie konverzácií, čistenie domovskej stránky, zobrazenie veľkých obrazoviek, zobrazenie na celú obrazovku a ďalšie. Urobme si našu skúsenosť s AI neuveriteľne hladkú, hedvábnistú, efektívnu a stručnú.
// @description:sr    ChatGPT dodatak za besprekorno ćaskanje. Otvorenog koda i besplatan. Ne samo da rešava sve greške i izbegava osvežavanje, već ima i napredne funkcije poput aktivnog stanja, isključivanja revizije, kloniranja razgovora, čišćenja početne stranice, prikazivanja velikih ekrana, prikazivanja punog ekrana i mnoge druge. Učinimo naše AI iskustvo izuzetno glatkim, svilenkastim, efikasnim i sažetim.
// @description:sv    ChatGPT-plugin för sömlös chatt. Öppen källkod och gratis. Den löser inte bara alla fel och undviker uppdatering, utan har också flera avancerade funktioner som att hålla sig aktiv, inaktivera revision, klona konversationer, rensa startsidan, visa stora skärmar, visa helskärm och mycket mer. Låt oss göra vår AI-upplevelse otroligt smidig, silkeslen, effektiv och koncis.
// @description:th    ปลั๊กอิน ChatGPT สำหรับการสนทนาที่ราบรื่น โอเพนซอร์สและฟรี มันไม่เพียงแก้ไขข้อผิดพลาดทั้งหมดและหลีกเลี่ยงการรีเฟรชเท่านั้น แต่ยังมีคุณลักษณะขั้นสูงหลายรายการ เช่น การเป็นใจเย็นตลอดเวลา การยกเลิกการตรวจสอบ, การโคลนสนทนา, การทำความสะอาดหน้าเว็บหลัก, การแสดงหน้าจอขนาดใหญ่, การแสดงหน้าจอเต็มจอ และอื่น ๆ อีกมากมาย มาทำให้ประสบการณ์ AI ของเราเป็นเรื่องราบรื่น, นุ่มนวล, มีประสิทธิภาพและกระชับมากขึ้นกันเถอะ
// @description:tr    Sorunsuz sohbet için ChatGPT eklentisi. Açık kaynaklı ve ücretsiz. Sadece tüm hataları çözmekle kalmaz ve yenilemeyi önlemez, aynı zamanda aktif kalma, denetimi iptal etme, konuşmaları klonlama, ana sayfayı temizleme, büyük ekranları gösterme, tam ekran gösterme ve çok daha fazlası gibi birçok gelişmiş özelliğe de sahiptir. AI deneyimimizi inanılmaz derecede sorunsuz, pürüzsüz, verimli ve öz olarak yapalım.
// @description:uk    Плагін ChatGPT для безперебійного спілкування. Відкритий вихідний код та безкоштовний. Він не лише вирішує всі помилки та уникне оновлення, але також має багато продвинутих функцій, таких як підтримка активності, скасування аудиту, клонування розмов, очищення головної сторінки, відображення великих екранів, відображення повноекранного режиму та багато іншого. Давайте зробимо наше AI-враження надзвичайно плавним, шовковистим, ефективним та стислим.
// @description:ug    ChatGPT-مەزمۇنى بەلگىلەنگەن ھەرخىل مەسلىھەت سەھىپىسى ۋاسىتىسى بوپ، تۆۋەندىكى مەقسەتتە پەش قىلىپ بەرىلدى: چاتGPT تامامەن دەرىجىدە ئىشلەتكۈچىلەرگە بىر بېزىق بولىدۇ. ئېچىلگەن كود ياكى تاپشۇرۇق بەلگىلەنگەن. بۇ يوللانما ئىشلەتكۈچىلەرغا ھەممە قاتارلىق خاتالىقلارنى چەكلەمىدىغانلىقى بولىدۇ، بەلكى ئالاھىدە ئىقتىدارلارنىمۇ چۈشۈرۈشى مۇمكىن، مەسىلەھەتتىن قوزغاتمىغانلاشتۇرۇشتا، سۆڭكە چاتلارنى كىرگۈزۈشتە، تەمىرلەش بەت يازمىنى تازىلاشتا، چوڭ ئېكراننى كۆرسىتىشتە، تولقۇن ئېكراننى كۆرسىتىشتە ۋە يېقىنداق باشقا ئىقتىدارلارنىمۇ ئېمگەن. AI ئەجدادىمىزنىڭ تەجرىبىسىنى ئىنىقئىسىز, تەرەككۈرلۈك, ئەجدارلىق ۋە قىسقاق قىلىپ بەرىمىز.
// @description:vi    Tiện ích ChatGPT cho cuộc trò chuyện liền mạch. Mã nguồn mở và miễn phí. Không chỉ giải quyết tất cả các lỗi và tránh làm mới, mà còn có nhiều tính năng nâng cao như duy trì hoạt động, hủy đánh giá, sao chép cuộc trò chuyện, làm sạch trang chủ, hiển thị màn hình lớn, hiển thị toàn màn hình và nhiều tính năng khác. Hãy làm cho trải nghiệm AI của chúng ta trở nên mượt mà, mềm mại, hiệu quả và ngắn gọn.
// @description:zh-CN ChatGPT畅聊与增强插件。开源免费。不仅能解决所有报错不再刷新，还有保持活跃、取消审计、克隆对话、净化首页、展示大屏、展示全屏等多个高级功能。让我们的AI体验无比顺畅、丝滑、高效、简洁。
// @description:zh-TW ChatGPT順暢聊天與增強插件。開源免費。不僅能解決所有報錯不再刷新，還有保持活躍、取消稽核、克隆對話、淨化首頁、展示大屏、展示全屏等多個高級功能。讓我們的AI體驗無比順暢、絲滑、高效、簡潔。
