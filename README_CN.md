...
| 实验环境 | 步骤1 | 步骤2 | 步骤3 | 步骤4 | 步骤5 | 步骤6 | 步骤7 | 步骤8 | 步骤9 | 步骤10 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 不勾选```克隆对话``` | 下发指令 | 得到结果 | 对结果不满意 | 鼠标点击指令的开头不放 | 鼠标滚轮滚动 | 鼠标拖拉到指令的结尾 | 复制指令 | 鼠标点击对话框 | 粘贴指令 | 开始调整指令 |
| 勾选```克隆对话``` | 下发指令 | 得到结果 | 对结果不满意 | 点击对话头像 | 开始调整指令 |  |  |  |  |  |
